...
<Project Type="Project" LVVersion="18008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Express VI Content" Type="Folder">
			<Item Name="Configure CreateCustomErrorWithData.vi" Type="VI" URL="../_CreateCustomErrorWithDataConfig.llb/Configure CreateCustomErrorWithData.vi"/>
			<Item Name="CreateCustomErrorWithData Source.vi" Type="VI" URL="../CreateCustomErrorWithDataSource.llb/CreateCustomErrorWithData Source.vi"/>
			<Item Name="subCreateCustomErrorWithData.vi" Type="VI" URL="../CreateCustomErrorWithDataSource.llb/subCreateCustomErrorWithData.vi"/>
		</Item>
		<Item Name="Test" Type="Folder">
			<Item Name="TestNoLibrary.vi" Type="VI" URL="../TestNoLibrary.vi"/>
			<Item Name="ErrorDefinitionSQLite_TestClass.vi" Type="VI" URL="../ErrorDefinitionSQLite/ErrorDefinitionSQLite_TestClass.vi"/>
		</Item>
		<Item Name="ErrorDefinitionSQLite.lvclass" Type="LVClass" URL="../ErrorDefinitionSQLite/ErrorDefinitionSQLite.lvclass"/>
		<Item Name="testttt.lvclass" Type="LVClass" URL="../ErrorDefinitionSQLite/testttt/testttt.lvclass"/>
		<Item Name="ErrorCreationExecution.lvclass" Type="LVClass" URL="../ErrorCreationExecution/ErrorCreationExecution.lvclass"/>
		<Item Name="ErrorCreationMGI.lvclass" Type="LVClass" URL="../ErrorCreationTypes/ErrorCreationMGI/ErrorCreationMGI.lvclass"/>
		<Item Name="OpenDBEditor.vi" Type="VI" URL="../OpenDBEditor.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="ConfigurationHandling.vi" Type="VI" URL="../_CreateCustomErrorWithDataConfig.llb/ConfigurationHandling.vi"/>
			<Item Name="ConfigurationData.ctl" Type="VI" URL="../_CreateCustomErrorWithDataConfig.llb/ConfigurationData.ctl"/>
			<Item Name="SetLabelPosition.vi" Type="VI" URL="../_CreateCustomErrorWithDataConfig.llb/SetLabelPosition.vi"/>
			<Item Name="GetSubVIReference.vi" Type="VI" URL="../_CreateCustomErrorWithDataConfig.llb/GetSubVIReference.vi"/>
			<Item Name="MergeError.vi" Type="VI" URL="../_CreateCustomErrorWithDataConfig.llb/MergeError.vi"/>
			<Item Name="GetVIProperties.vi" Type="VI" URL="../_CreateCustomErrorWithDataConfig.llb/GetVIProperties.vi"/>
			<Item Name="FillListBox.vi" Type="VI" URL="../_CreateCustomErrorWithDataConfig.llb/FillListBox.vi"/>
			<Item Name="GetAllEntriesFromDatabase.vi" Type="VI" URL="../_CreateCustomErrorWithDataConfig.llb/GetAllEntriesFromDatabase.vi"/>
			<Item Name="UpdateCodeText.vi" Type="VI" URL="../_CreateCustomErrorWithDataConfig.llb/UpdateCodeText.vi"/>
			<Item Name="GUIFunctions.ctl" Type="VI" URL="../_CreateCustomErrorWithDataConfig.llb/GUIFunctions.ctl"/>
			<Item Name="TryMakeErrorObsolete.vi" Type="VI" URL="../_CreateCustomErrorWithDataConfig.llb/TryMakeErrorObsolete.vi"/>
		</Item>
